...
def test_st_registers_twelve_tools(reg):
    """st_* 12 工具全部注册为 L1_compute（Phase 48 +st_vicinity）。"""
...
def test_register_twelve_st_tools(reg):
    """Phase 48 后 st_* 共 12 工具（11 + st_vicinity）。"""

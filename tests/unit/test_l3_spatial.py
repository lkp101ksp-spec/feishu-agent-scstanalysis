...
def test_st_registers_thirteen_tools(reg):
    """st_* 13 工具全部注册为 L1_compute（Phase 49 +st_misty）。"""
...
def test_register_thirteen_st_tools(reg):
    """Phase 49 后 st_* 共 13 工具（12 + st_misty）。"""

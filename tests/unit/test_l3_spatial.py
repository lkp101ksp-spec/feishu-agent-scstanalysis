...
def test_st_registers_eleven_tools(reg):
    """st_* 11 工具全部注册为 L1_compute（Phase 47 +st_niche）。"""
...
def test_register_eleven_st_tools(reg):
    """Phase 47 后 st_* 共 11 工具（10 + st_niche）。"""
